...
export const overviewContent = {
  timing: {
    paragraphs: [
      ...
      "All Normal medals are eventually required to unlock Indomitus Elite. Make the final medal cleanup when Elite becomes your next useful progression goal, not simply because an unfinished stage is visible. Recommended Investment targets are practical, repeatable goals—not the lowest ranks that can win with perfect positioning, favorable critical hits, blocks, or repeated attempts.",
    ],
    callout: "Clear first. Medal later. Push until progress becomes expensive, then branch out—Indomitus should anchor your early account without blocking progress elsewhere.",
  },
  progression: {
    ...
    steps: [
      ...
      "Invest most heavily in Bellator, then raise Varro and Certus enough to survive and perform their roles.",
    ...
    callout: "Clear first. Medal later. Build the Required Carry first, then invest when the next unlock is worth it.",
  },
  ...
  strategyTips: [
    ["Build the Required Carry First", "Bellator is the Required Carry, and Death from Above is the campaign’s most important ability. It summons one Inceptor for each round that has begun, so waiting can create a larger force—but summon earlier when Scarabs, Deathmarks, or a backline breach require an immediate answer."],
    ...
    ["Manipulate Enemy Targeting", "Bellator, Yarrick, and Mataneo create additional bodies that can block movement, occupy preferred attack hexes, and redirect enemy attacks. Many low-investment Elite clears work because enemies never reach the required backline."],
...
export const requiredHeroContent: HeroGuide[] = [
  {
    ...
    paragraphs: [
      ...
      "For Normal, Bronze I is a comfortable target rather than a requirement. For Elite, Silver I is a practical, repeatable survival target that does not assume a premium support, favorable RNG, or many restart attempts.",
  ...
  },
  {
    ...
    ...targetsFor("Bella"),
    paragraphs: [
      "Bellator is the Required Carry. His active summons one Inceptor for each round that has begun, giving the team damage, extra bodies, route blocking, and safer targets for enemy attacks.",
      ...
      "Silver I is more than Normal strictly requires, but Bellator remains the Required Carry in Elite and a strong account-wide investment. Gold I is the practical Elite recommendation because it produces repeatable progress without assuming a rare healer, an overbuilt support, or favorable RNG.",
    ],
    callout: "Required Carry: build Bellator’s rank and Death from Above first.",
    featured: true,
  },
];
...
export const supportingHeroGroups: Array<{ id: string; title: string; heroes: HeroGuide[] }> = [
  ...
  },
  {
    ...
    heroes: [
      ...
      { characterId: "custoBladeChampion", heading: "Kariyan", role: "High-investment carry and frontline support.", paragraphs: ["Diamond-rank Kariyan can carry unrestricted Elite stages and compensate for an underbuilt required hero. That proves what an already-developed Kariyan can do; it does not make him a practical beginner investment target.", "Kariyan is an option for players who already have him heavily developed, not a character someone should build specifically to complete Indomitus Elite."], callout: "Use him when already built; do not treat him as a required campaign project." },
      { characterId: "bloodDeathCompany", heading: "Lucien", role: "Mobile damage carry and multi-kill threat remover.", paragraphs: ["Lucien contributes through direct pressure rather than healing or defensive support. His mobility and charge damage allow him to reach exposed Scarabs, Warriors, or ranged enemies before they attack. Community reports describe him removing multiple vulnerable targets in one turn.", "Gold I is a meaningful middle-to-late Elite target. Gold II is more appropriate when he is expected to supply most of the final-chapter damage. Abilities around levels 30–35 are sufficient unless Lucien is a broader roster priority.", "He cannot revive or passively protect the required trio, but he can reduce incoming damage by removing threats quickly."], callout: "A fast offensive solution when survival improves by killing first." },
...
export const difficultStageGroups = [
  ...
  { id: "difficult-elite-stages", modeId: "elite", title: "Elite", stages: [
    ...
    { number: 35, title: "Mandatory-Hero Survival", why: "Elite 35 is a late three-character survival and equipment check. Successful teams vary widely: some use balanced Silver and Gold investment, while others concentrate almost every resource into Bellator.", strategy: ["Move your best defensive gear onto Varro and Certus.", "Keep both required backliners behind Bellator whenever possible.", "Use summons to occupy attack hexes and redirect enemy movement.", "Do not assume one specific rank combination is required.", "Very low-rank clears often depend on strong equipment, critical hits, blocks, exact deployment, or favorable enemy behavior.", "A few restarts can be efficient; if success requires repeated lucky openings, invest toward the Recommended Investment instead."], closing: "Stage 35 can be solved through balanced investment or through a heavily developed Bellator. It is not governed by one clean rank threshold." },
    { number: 37, title: "Deathmark and Ophydian Pressure", why: "Elite 37 produces some of the strongest frustration reports in the campaign. Deathmarks and Ophydian Destroyers can one-shot Varro, Certus, and even Bellator’s summoned Inceptors.", strategy: ["Deny Deathmarks a stationary, elevated firing position.", "Use terrain, another hero, or a summon to block line of sight.", "Keep Varro and Certus away from isolated Ophydian landing zones.", "Occupy useful destination hexes with Bellator, a durable support, or summons.", "Preserve Varro’s active or another burst tool for the turn an Ophydian emerges.", "Counter-snipe with Certus only when the Deathmark will certainly die and Certus will remain safe."], closing: "This stage is often won during deployment. The safest opening may involve hiding the required heroes and forcing enemies to move into less favorable attack positions." },
    { number: 40, title: "Anuphet", why: "Elite 40 is frequently the final stage preventing 120/120 completion. Anuphet, Warriors, Flayed Ones, Scarabs, and Destroyers create several simultaneous priorities, and one exposed required hero can end the attempt.", strategy: ["Clear one side of the map to create a safe retreat area.", "Anticipate where the first Destroyer will emerge.", "Move Certus and other vulnerable heroes before that emergence turn.", "Preserve multiple active abilities to burst the Destroyer immediately.", "Use Bellator’s Inceptors or another summon to block the second Destroyer.", "Place the most durable hero in front of Anuphet and the Warriors.", "Pressure Anuphet once the immediate Destroyer threat is controlled.", "Hide any damaged required hero during cleanup."], closing: "Elite 40 rewards a turn plan more than a damage race. Decide before the battle which side you will clear, where vulnerable heroes will retreat, and which abilities are reserved for the Destroyers." },
  ]},
];
