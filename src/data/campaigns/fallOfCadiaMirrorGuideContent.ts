...
export const overviewContent = {
  timing: {
    callout: "Complete Normal relatively early, farm its efficient nodes, and return to Elite when the guaranteed drops justify the investment.",
    paragraphs: [
      ...
      "Elite becomes more attractive once the account has a strong shared Imperial support core. Its guaranteed first upgrade copy makes several Astra Militarum and general progression nodes especially valuable.",
    ],
  },
  progression: {
    callout: "Thaddeus carries, Kut screens, Sibyll supplies protected Psychic and Infiltrate utility, and Isabella is the MVP whenever supports are permitted.",
    ...
    steps: [
      ...
      "Build around Thaddeus instead of equalizing the required trio.",
    ...
    paragraphs: [
      ...
      "Normal mixes three-, four-, and five-character deployments. Elite 2, 12, 29, and 36 allow only Kut, Sibyll, and Thaddeus, so no support hero can replace investment in the mandatory trio.",
    ],
  },
  ...
  strategyTips: [
    ...
    ["Make Thaddeus the Carry", "Use Basilisk Barrage for priority targets, protected clusters, and Havoc Suppression. Preserve clear firing lanes and avoid committing Thaddeus before the Barrage decision is made."],
    ...
    ["Start With Isabella", "On unrestricted stages, position Isabella behind the frontline and adjacent to the heroes most likely to take damage. Her healing and resurrection create the safest three-medal margin."],
...
export const requiredHeroContent: HeroGuide[] = [
  ...
  },
  {
    ...
    ...targetsFor("Thad"),
    paragraphs: [
      "Thaddeus is the required hero to build around. His range lets him work behind Kut, while Basilisk Barrage can soften or remove a priority target anywhere on the map when he has not moved.",
    ...
    callout: "Thaddeus carries: preserve his firing lanes and invest where the damage bottleneck actually is.",
    featured: true,
  },
];
...
export const bestSupportingHero: HeroGuide = {
  ...
  heading: "Isabella",
  role: "Healing, regeneration, resurrection, and three-medal insurance.",
  paragraphs: [
    "Isabella is the clear Fall of Cadia Mirror MVP.",
  ...
  callout: "If Isabella is allowed on the map, start team-building with her.",
  featured: true,
};
...
export const difficultStageGroups = [
  ...
  { id: "difficult-elite-stages", modeId: "elite", title: "Elite", stages: [
    { number: 2, title: "First Trio-Only Test", why: "The first Elite restriction immediately removes healers and premium carries.", strategy: ["Let Kut own the contact hex.", "Keep Thaddeus stationary until the Barrage decision is made.", "Use Sibyll's adjacency utility without exposing her.", "Treat the stage as a formation test rather than inferring a minimum rank from one replay."], closing: "This stage asks whether the trio functions without Isabella, not whether your support roster is strong." },
    { number: 12, title: "Trio-Only Formation Check", why: "Another support-free map tests the same compact formation at a higher enemy threshold.", strategy: ["Inspect Overwatch lanes before moving.", "Preserve Kut's health by controlling who can contact him.", "Keep Sibyll protected and let Thaddeus solve the damage bottleneck.", "Do not invent a special rank threshold from the current evidence gap."], closing: "Use the trio principles consistently: Kut screens, Thaddeus carries, Sibyll stays protected." },
    { number: 29, title: "Late Trio-Only Gate", why: "The late restriction exposes weak required characters, while replay ranks vary too widely to define one universal minimum.", strategy: ["Do not plan around Isabella; she cannot deploy.", "Move the best defensive gear to the hero who dies first.", "Use Kut to deny the cleanest route into Thaddeus or Sibyll.", "Treat extremely low-rank clears as proof of possibility, not a beginner baseline."], closing: "Positioning and concentrated investment matter more than equal ranks across the trio." },
    { number: 36, title: "Final Trio-Only Gate", why: "This is the best-calibrated required-trio check and one of the campaign's most important investment tests.", strategy: ["Use Silver-range Kut and Sibyll as protected utility while Gold-range Thaddeus supplies the damage.", "Solve Havoc Overwatch before moving a vulnerable hero.", "Restart an opening that creates an unrecoverable backline breach.", "Add durability only where the actual death occurs."], closing: "The most transferable clears build around Thaddeus rather than promoting the trio equally." },
    { number: 39, title: "Penultimate Support Stage", why: "Supports return, but late-Elite damage and positioning still punish a fragile formation.", strategy: ["Start with Isabella when available.", "Add a durable body or mobile threat remover that already serves the wider account.", "Keep the likely casualty adjacent to Isabella.", "Treat optimized low-rank clears as demonstrations, not universal targets."], closing: "Isabella adds enormous leverage here, but she still needs a formation that prevents clean one-shots." },
